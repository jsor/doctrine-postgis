...
class ST_WithinTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_Within(ST_Buffer(ST_GeomFromText(\'POINT(50 50)\'), 20), ST_Buffer(ST_GeomFromText(\'POINT(50 50)\'), 40)) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
