...
class ST_LineFromMultiPointTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_AsEWKT(ST_LineFromMultiPoint(ST_GeomFromEWKT(\'MULTIPOINT(1 2 3, 4 5 6, 7 8 9)\'))) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
