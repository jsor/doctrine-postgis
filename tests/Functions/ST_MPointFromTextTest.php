...
class ST_MPointFromTextTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_MPointFromText(\'MULTIPOINT(-70.9590 42.1180, -70.9611 42.1223)\', 4326) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
  ...
  'value' => '0104000020E61000000200000001010000004C37894160BD51C0C976BE9F1A0F45400101000000E10B93A982BD51C08126C286A70F4540',
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_MPointFromText(\'POINT(1 2)\') AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
