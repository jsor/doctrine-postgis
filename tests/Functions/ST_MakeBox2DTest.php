...
class ST_MakeBox2DTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_MakeBox2D(ST_MakePoint(-989502.1875, 528439.5625), ST_MakePoint(-987121.375 ,529933.1875)) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
