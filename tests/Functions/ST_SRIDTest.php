...
class ST_SRIDTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_SRID(ST_GeomFromText(\'POINT(-71.1043 42.315)\',4326)) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
