 ...
 * @group functions
 */
final class ST_GeoHashTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_GeoHash(ST_GeomFromText(\'SRID=4326;POINT(-126 48)\')) AS value FROM Jsor\\Doctrine\\PostGIS\\Entity\\PointsEntity point');
