...
class ST_CoordDimTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_CoordDim(ST_GeomFromText(\'LINESTRING(1 1,0 0, -1 1)\')) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
