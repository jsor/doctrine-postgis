...
class ST_IsValidTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_IsValid(ST_GeomFromText(\'POLYGON((0 0, 1 1, 1 2, 1 1, 0 0))\')) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
  ...
  'value' => false,
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_IsValid(ST_GeomFromText(\'LINESTRING(0 0, 1 1)\')) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
