...
class ST_IntersectsTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_Intersects(ST_GeomFromText(\'POINT(0 0)\'), ST_GeomFromText(\'LINESTRING(0 0, 0 2)\')) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
