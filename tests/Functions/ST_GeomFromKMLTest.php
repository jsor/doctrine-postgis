...
class ST_GeomFromKMLTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_AsText(ST_GeomFromKML(\'<LineString><coordinates>-71.1663,42.2614 -71.1667,42.2616</coordinates></LineString>\')) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
