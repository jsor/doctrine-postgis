...
class ST_TransScaleTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_AsEWKT(ST_TransScale(ST_GeomFromEWKT(\'LINESTRING(1 2 3, 1 1 1)\'), 0.5, 1, 1, 2)) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
