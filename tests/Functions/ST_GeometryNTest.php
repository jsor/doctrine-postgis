...
class ST_GeometryNTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_AsEWKT(ST_GeometryN(ST_GeomFromText(\'MULTILINESTRING((0 0 1, 1 1 1, 1 2 1, 1 1 1, 0 0 1))\'), 1)) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
