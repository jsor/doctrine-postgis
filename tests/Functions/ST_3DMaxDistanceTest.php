...
class ST_3DMaxDistanceTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_3DMaxDistance(ST_GeomFromEWKT(\'POINT Z (1 1 1)\'), ST_GeomFromEWKT(\'POINT Z (2 2 2)\')) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
