...
class ST_LineFromTextTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_LineFromText(\'LINESTRING(1 2, 3 4)\', 4326) FROM Jsor\\Doctrine\\PostGIS\\PointsEntity');
  ...
  1 => '0102000020E610000002000000000000000000F03F000000000000004000000000000008400000000000001040',
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_LineFromText(\'POINT(1 2)\') FROM Jsor\\Doctrine\\PostGIS\\PointsEntity');
