...
class ST_PointFromWKBTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_PointFromWKB(ST_AsEWKB(ST_PointFromText(\'POINT(-71.064544 42.28787)\')), 4326) FROM Jsor\\Doctrine\\PostGIS\\PointsEntity');
