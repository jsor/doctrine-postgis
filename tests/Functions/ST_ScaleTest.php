...
class ST_ScaleTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_AsEWKT(ST_Scale(ST_GeomFromEWKT(\'LINESTRING(1 2 3, 1 1 1)\'), 0.5, 0.75, 0.8)) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
