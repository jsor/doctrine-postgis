...
class ST_ExteriorRingTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_AsEWKT(ST_ExteriorRing(ST_GeomFromText(\'POLYGON((0 0 1, 1 1 1, 1 2 1, 1 1 1, 0 0 1))\'))) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
