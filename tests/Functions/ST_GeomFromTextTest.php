...
class ST_GeomFromTextTest extends AbstractFunctionalTestCase
{
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_GeomFromText(\'LINESTRING(-71.160281 42.258729,-71.160837 42.259113,-71.161144 42.25932)\') AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
  ...
  'value' => '010200000003000000E44A3D0B42CA51C06EC328081E21454027BF45274BCA51C0F67B629D2A214540957CEC2E50CA51C07099D36531214540',
    ...
    {
        $query = $this->_getEntityManager()->createQuery('SELECT ST_GeomFromText(\'LINESTRING(-71.160281 42.258729,-71.160837 42.259113,-71.161144 42.25932)\',4269) AS value FROM Jsor\\Doctrine\\PostGIS\\Test\\fixtures\\PointsEntity point');
